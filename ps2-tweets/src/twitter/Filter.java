...
public class Filter {
	...
	public static List<Tweet> writtenBy(List<Tweet> tweets, String username) {
		return tweets.stream().filter(tweet -> tweet.getAuthor().equals(username)).collect(Collectors.toList());
	}
	...
	public static List<Tweet> inTimespan(List<Tweet> tweets, Timespan timespan) {
		return tweets.stream().filter(
				t -> t.getTimestamp().isAfter(timespan.getStart()) && t.getTimestamp().isBefore(timespan.getEnd()))
